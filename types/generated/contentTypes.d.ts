...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imagenDestacada: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiEmpresaEmpresa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sitioWeb: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiExperienciaExperiencia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imagenCliente: Schema.Attribute.Media<
...
export interface ApiHeroSectionHeroSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activo: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    botonHero: Schema.Attribute.Component<'shared.boton-hero', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLandingPageLandingPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    formulario: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicioServicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    caracteristicas: Schema.Attribute.Enumeration<['caracteristica 1']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    categoria: Schema.Attribute.Enumeration<['categoria 1']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    descripcionLarga: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
